...
from App.Server.predictor_server import generate_model
...
def build_regression_model():
    try:
        ...
        model_name, model, cross_val_r2_mean_train, cross_val_r2_std_train, r2_valid = generate_model(catering)
        response = {
            "catering": catering,
